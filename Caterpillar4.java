/*
    ...
    Description: My Creation Assignment - Caterpillar 4; hawk drops caterpillar
*/
...
public class Caterpillar4 extends Thread
{
    private Console c;
    private Palette p;
    
    public Caterpillar4 (Console con, Palette pal) {
	c = con;
	p = pal;
    }
    ...
    public void caterpillarFall() {
	for (int i = 295; i < 550; i += 3) {
	    erase(165, i);
	    draw(165, i + 3);
	    sleep(35);
	}
