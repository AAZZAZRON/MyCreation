/*
    ...
    Description: My Creation Assignment - Caterpillar 3; caterpillar flies left with hawk
*/
...
public class Caterpillar3 extends Thread
{
    private Console c;
    private Palette p;
    
    public Caterpillar3 (Console con, Palette pal) {
	c = con;
	p = pal;
    }
    ...
    public void caterpillarFlyRight() {
	for (int i = 730; i > 165; i -= 3) {
	    erase(i + 3, 295);
	    draw(i, 295);
	    sleep(35);
	}
