/*
    ...
    Description: My Creation Assignment - Background 3
*/
...
public class Background3
{
	...
	for (int i = 0; i < 100; i += 1) {
	    c.drawOval(380 + i / 2, 200 + i / 2, 100 - i, 100 - i);
	}
	...
	drawRock(620, 460, 2, 1, p.ROCK_MEDIUM);
	drawRock(150, 470, 2, 1, p.ROCK_LIGHT);
    ...
    public Background3 (Console con, Palette pal)
    {
	c = con;
	p = pal;
	draw();
