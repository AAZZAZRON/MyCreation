/*
    ...
    Description: My Creation Assignment - Hawk 1; hawk swoops for caterpillar
*/
...
public class Hawk1 implements Runnable
{
    private Console c;
    private Palette p;
    int size = 2;
    
    public Hawk1 (Console con, Palette pal) {
	c = con;
	p = pal;
    }
